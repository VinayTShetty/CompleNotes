...
Reserved words--->keywords(if the reserved word is associated with functionality is called reserved word)
...
16 bit means instruction will be represented .
 ...
 A 16-bit microprocessor can process data and memory addresses that are represented by 16 bits. bus : 
...
----- so this-no 2147483648 is considered as integer only but its too large so 
